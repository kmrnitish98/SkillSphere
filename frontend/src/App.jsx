...
import VerifyCertificatePage from './pages/Student/VerifyCertificatePage';
    ...
    <AuthProvider>
      <Router>
        <SocketProvider>
          ...
          {/* ── Final Exam ── */}
          <Route path="/student/exam" element={<ProtectedRoute roles={['student']}><FinalExamPage /></ProtectedRoute>} />
