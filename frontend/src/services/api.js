...
export const getUnlockStatus    = (courseId)             => API.get(`/certificates/unlock-status/${courseId}`);
export const submitFinalExam    = (data)                 => API.post('/certificates/submit-exam', data);
...
export const getExamResult      = (courseId)             => API.get(`/certificates/exam-result/${courseId}`);
